    ...
    public partial class AddGiftCards : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiftCardCoupon", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GiftCardCoupon_GiftCard_GiftCardId",
                        column: x => x.GiftCardId,
                        principalTable: "GiftCard",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GiftCardCoupon_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GiftCardCoupon_CouponCode",
                table: "GiftCardCoupon",
                column: "CouponCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GiftCardCoupon_GiftCardId",
                table: "GiftCardCoupon",
                column: "GiftCardId");

            migrationBuilder.CreateIndex(
                name: "IX_GiftCardCoupon_OrderId",
                table: "GiftCardCoupon",
                column: "OrderId",
                unique: true,
